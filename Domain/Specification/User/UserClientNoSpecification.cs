...
{
    public class UserClientNoSpecification : Specification<Aggregates.UserAgg.User>
    {
        private readonly string _clientNo;
        public UserClientNoSpecification(string clientNo)
        {
        ...
        {
            return u => u.ClientNo.ToLower() == this._clientNo;
        }
    }
}
