...
namespace Portal.Web.Core
{
    ...
    public class RequestMessage
    {
        ...
        public static int DefaultTimeOut = 1 * 60000;
        ...
        public RequestMessage(string url, int timeOut)
        {
            UserAgent = DefaultUserAgent;
            TimeOut = timeOut > 0 ? timeOut * 60000 : DefaultTimeOut;
            Url = url;
        }
        #endregion

        #region 根据传进来的URL生成请求实例
